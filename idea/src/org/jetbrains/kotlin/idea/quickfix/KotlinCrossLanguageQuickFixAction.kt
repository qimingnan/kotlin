...
abstract class KotlinCrossLanguageQuickFixAction<out T : PsiElement>(element: T) : KotlinQuickFixActionBase<T>(element) {
    ...
    protected abstract fun doInvoke(project: Project, editor: Editor?, file: PsiFile)
}
